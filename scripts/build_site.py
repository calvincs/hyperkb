...
<meta name="theme-color" content="#0b1115"><link rel="stylesheet" href="{href('style.css')}"><link rel="stylesheet" href="{href('docs.css')}">
<script src="{href('docs.js')}" defer></script></head><body class="docs-page">
<a class="skip" href="#main">Skip to content</a>
<header class="site-header wrap"><a class="brand" href="{href('index.html')}" aria-label="HyperKB home"><img src="{href('mark.svg')}" width="30" height="30" alt=""><span>hyper<span class="brand-light">kb</span><span class="brand-dot">.</span></span></a><nav aria-label="Main navigation"><a href="{href('docs/index.html')}" aria-current="{('page' if route == 'docs/index.html' else 'false')}">Documentation</a><a href="{href('llms.txt')}">For agents</a><a href="{REPO_URL}">GitHub ↗</a></nav></header>
